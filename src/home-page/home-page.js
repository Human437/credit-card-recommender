    ...
    <main role="main">
        <div className = 'parallax1'>
          <header id='heading'>
            ...
            <h2 id='heading-h2' className='lp-heading'>Demystify credit cards</h2>
        ...
        <div id='trust'>
          <div id='text-4-trust'>
            ...
            <p>You don't have to. All the information here is easily accessible through a quick Google search. Now you might be wondering what is the point of the site if I can find all of the information by myself? Good question, the point of this site is to educate people who are just getting into the credit card game and don't have the time or simply don't want to spend hours looking up content from many places. This site is aiming to be a one-stop-shop for beginners who want a to-the-point card recommendation without any affiliate programs skewing our opinions. You are more than welcome to do your own research and even advise that you do so if you have the time, but we want to make what can seem like an overwhelming experience simple.</p>
          </div>
        </div>
    </main>
  )
